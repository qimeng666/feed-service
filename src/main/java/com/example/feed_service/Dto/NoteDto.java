...
public class NoteDto {
    ...
    public NoteDto(Long id, Long userId, String title, String content, LocalDateTime createdTime) {
        this.id = id;
        this.userId = userId;
        this.title = title;
        this.content = content;
    ...
    public String toString() {
        return "NoteDto(id=" + this.getId() + ", AuthorId=" + this.getUserId() + ", title=" + this.getTitle() + ", content=" + this.getContent() + ", createdTime=" + this.getCreatedTime() + ")";
    }
}
